...
ggsave("figs/plt_census_pct_change_census_crude.png")
...
ggsave("figs/plt_census_pct_change_census_crude_covid.png")
...
df_age_adj %>%
  ...
  theme(plot.caption=element_text(hjust = 0)) + guides(fill=guide_legend(title="")) +
  theme(axis.text.x = element_text(angle = 80))
ggsave("figs/plt_census_pct_change_census_age_adj.png")
...
df_age_adj_covid %>%
  ...
  theme(plot.caption=element_text(hjust = 0)) + guides(fill=guide_legend(title="")) +
  theme(axis.text.x = element_text(angle = 80, vjust=.75))
ggsave("figs/plt_census_pct_change_census_age_adj_covid.png")
