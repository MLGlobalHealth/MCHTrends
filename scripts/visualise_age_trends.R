...
df_mm2 <- clean_df('maternal_mortality_age_11_19')
df_mm_covid <- clean_df('maternal_mortality_age_20_21')

df_mmno1 <- clean_df('maternal_mortality_spec_age_00_10')
df_mmno2 <- clean_df('maternal_mortality_spec_age_11_19')
df_mmno_covid <- clean_df('maternal_mortality_spec_age_20_21')

df_mmot1 <- clean_df('other_mat_mortality_age_00_10')
df_mmot2 <- clean_df('other_mat_mortality_age_11_19')
df_mmot_covid <- clean_df('other_mat_mortality_age_20_21')

df_pr1 <- clean_df('pregrel_mortality_age_00_10')
df_pr2 <- clean_df('pregrel_mortality_age_11_19')
df_pr_covid <- clean_df('pregrel_mortality_age_20_21')
...
df_nat1 <- clean_nat_df('natality_age_year_00_02', 
                        Age.of.Mother, Age.of.Mother.Code) 
df_nat2 <- clean_nat_df('natality_age_year_03_06', 
                        Age.of.Mother.9, Age.of.Mother.9.Code) 
df_nat3 <- clean_nat_df('natality_age_year_07_21', 
                        Age.of.Mother.9, Age.of.Mother.9.Code) %>%
...
ggsave("figs/plt_pct_change_age_groups.png")
...
df_crude_covid %>%
  ...
  theme(plot.caption=element_text(hjust = 0)) + guides(fill=guide_legend(title="")) +
  theme(axis.text.x = element_text(angle = 80, vjust=.6))
ggsave("figs/plt_pct_change_age_groups_covid.png")
